...
evens = np.where(array % 2 == 0, array, 0) # The where function conserves the shape of the list by substituting number that don't match the requirements with something else. 
